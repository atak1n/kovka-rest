...
export default {
  ...
  computed: {
    ...
    socials() {
      return [
        this.$store.state.contacts.whatsapp,
        this.$store.state.contacts.telegram,
        this.$store.state.contacts.instagram,
        this.$store.state.contacts.vk,
        this.$store.state.contacts.profi,
      ]
    }
  },
  methods: {
